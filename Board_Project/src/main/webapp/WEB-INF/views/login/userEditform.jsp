...
<script>	
	...
	$(document).ready(function() {
		...
		$("#submit").on("click", function() {
			...
			var sessionNickname = '<%=(String)session.getAttribute("nickname")%>';
			var editNickname = $('#nickname').val();
			if(sessionNickname != editNickname) {
			...
			alert("회원정보 수정이 완료됐습니다. 다시 로그인 하세요.");
		});
	})
</script>
<body>
	...
	<div class="container">
		...
		<form action="/login/updateUser" method="POST">
			...
			<div class="form-group">
				...
				placeholder="게시글 작성시 별명으로 표시됩니다." required style="width:315px" value="${user.nickname }">
			...
			<div class="form-group">
				...
				placeholder="ex) fish@fish.com" required style="width:315px" value="${ user.email }">
			...
			<div class="form-group">
				...
				placeholder="ex) 01012341234" required value="${user.tel }">
